/**
 * Dialog — Radix Dialog with paper-card aesthetic.
 *
 *   <Dialog>
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-50 bg-[rgba(28,26,50,0.45)]",
    ...
    >
      ...
      <DialogPrimitive.Close
        className={cn(
          ...
          "text-ink-4 transition-colors hover:bg-secondary hover:text-foreground",
