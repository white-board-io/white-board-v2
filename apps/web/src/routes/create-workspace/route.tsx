...
const WORKSPACE_TYPES = [
  ...
  { value: "training_institute", label: "Training Institute", description: "In-person coaching or training", Icon: GraduationCap, comingSoon: true },
  { value: "online_institute", label: "Online Institute", description: "Fully remote teaching", Icon: Globe, comingSoon: true },
] as const;
